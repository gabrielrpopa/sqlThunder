...
public class ScriptDetail implements RestInterface {
	...
	public ScriptDetail(final InterpreterType interpreterType,
						final String scriptName) {

		this.setInterpreterId(interpreterType.getInterpreterId());
		this.setInterpreterName(interpreterType.getInterpreterName());
		this.setInterpreterVersion(interpreterType.getInterpreterVersion());
		this.setInterpreterPath(interpreterType.getInterpreterPath());
		this.setCommand(interpreterType.getCommand());
		this.setScriptName(scriptName);
	}
