...
public class Conversions {
	...
	String getRdbmsToRdbmsMapping(	String type,
									String from,
									String to) {
		if(from.compareTo("H2") == 0) {
			if(Objects.equals(to, "H2")) {
				return type;
			} else if(Objects.equals(to, "POSTGRES")) {
				return type;
			} else if(Objects.equals(to, "ORACLE")) {
				return type;
			} else if(Objects.equals(to, "SQLSERVER")) {
				return type;
			} else if(Objects.equals(to, "SYBASE")) {
				return type;
			} else {
				return "";
			}
		} else if(from.compareTo("POSTGRES") == 0) {
			if(Objects.equals(to, "H2")) {
				return type;
			} else if(Objects.equals(to, "POSTGRES")) {
				return type;
		...
		} else if(from.compareTo("ORACLE") == 0) {
			if(Objects.equals(to, "H2")) {
				return type;
			} else if(Objects.equals(to, "POSTGRES")) {
				return type;
		...
		} else if(from.compareTo("SQLSERVER") == 0) {
			if(Objects.equals(to, "H2")) {
				return type;
			} else if(Objects.equals(to, "POSTGRES")) {
				return type;
		...
		} else if(from.compareTo("SYBASE") == 0) {
			if(Objects.equals(to, "H2")) {
				return type;
			} else if(Objects.equals(to, "POSTGRES")) {
				return type;
