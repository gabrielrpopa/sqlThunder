...
public class InternalFileStorageList implements RestInterface{
	...
	public InternalFileStorageList() {
		this.setFileStorageTableDbRecordLst(new ArrayList<>());
	}
	...
	public void addFileStorageTableDbRecordLst(List<InternalFileStorageRecord> fileStorageTableDbRecordLst) { this.fileStorageTableDbRecordLst.addAll( fileStorageTableDbRecordLst ); }
	public void addFileStorageTableDbRecord(InternalFileStorageRecord r) { this.fileStorageTableDbRecordLst.add( r ); }
