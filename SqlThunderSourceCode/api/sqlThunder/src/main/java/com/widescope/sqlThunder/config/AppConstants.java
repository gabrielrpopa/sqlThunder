...
public class AppConstants {
	...
	@Value("${script.storage.path}")
	private String scriptStoragePath;  
	public String getScriptStoragePath() {	return scriptStoragePath; }
	public void setScriptStoragePath(String scriptStoragePath) { this.scriptStoragePath = scriptStoragePath; }
	
	@Value("${hist.statement.path}")
	private String histStatementPath;  
	public String getHistStatementPath() {	return histStatementPath; }
	public void setHistStatementPath(String sqlStoragePath) { this.histStatementPath = sqlStoragePath; }

	@Value("${script.execution.path}")
	private String scriptExecutionPath;  
	public String getScriptExecutionPath() {	return scriptExecutionPath; }
	public void setScriptExecutionPath(String scriptExecutionPath) { this.scriptExecutionPath = scriptExecutionPath; }
	
	@Value("${script.result.path}")
	private String scriptResultPath;  
	public String getScriptResultPath() {	return scriptResultPath; }
	public void setScriptResultPath(String scriptResultPath) { this.scriptResultPath = scriptResultPath; }
	
	@Value("${script.log.path}")
	private String scriptLogPath;  
	public String getScriptLogPath() {	return scriptLogPath; }
	public void setScriptLogPath(String scriptLogPath) { this.scriptLogPath = scriptLogPath; }
	
	@Value("${script.temp.path}")
	private String scriptTempPath;  
	public String getScriptTempPath() {	return scriptTempPath; }
	public void setScriptTempPath(String scriptTempPath) { this.scriptTempPath = scriptTempPath; }
	
	@Value("${script.lib.path}")
	private String scriptLibPath;  
	public String getScriptLibPath() {	return scriptLibPath; }
	public void setScriptLibPath(String scriptLibPath) { this.scriptLibPath = scriptLibPath; }
	
	@Value("${script.model.path}")
	private String scriptModelPath;  
	public String getScriptModelPath() {	return scriptModelPath; }
	public void setScriptModelPath(String scriptModelPath) { this.scriptModelPath = scriptModelPath; }
	...
	private String chat_storage_path;
	public String getChatStoragePath( ) { return chat_storage_path; }
