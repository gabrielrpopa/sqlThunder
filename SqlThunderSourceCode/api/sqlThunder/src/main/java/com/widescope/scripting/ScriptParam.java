...
public class ScriptParam {
	...
	public ScriptParam(	final int scriptParamId,
	...
	public ScriptParam(	final ScriptParamDetail scriptParamDetail) {
		this.scriptParamId = scriptParamDetail.getScriptParamId();
		this.paramName = scriptParamDetail.getParamName();
		this.value = "";
	}
