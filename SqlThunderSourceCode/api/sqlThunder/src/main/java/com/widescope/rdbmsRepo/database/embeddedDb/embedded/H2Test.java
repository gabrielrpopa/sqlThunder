...
public class H2Test implements  EmbeddedInterface {
	...
	@Override
	public ResultQuery execStaticQueryToWebsocket(String user, long userId, String requestId, String jobId, String staticQuery,
			String sqlName, String httpSession, String persist)  {
		// TODO Auto-generated method stub
		return null;
	}
