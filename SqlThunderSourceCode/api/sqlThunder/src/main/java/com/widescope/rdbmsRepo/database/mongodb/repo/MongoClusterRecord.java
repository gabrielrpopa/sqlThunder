...
public class MongoClusterRecord implements RestInterface{
	...
	private final MongoClusterMaxRecord maxDbTemp;
	private MongoClusterMaxRecord maxDbUser;
	private final long maxCountUser;
	...
	public MongoClusterRecord()	{
		...
		this.maxDbTemp = this.getMaxDbTemp_();
		this.maxDbUser = this.getMaxDbUser_();
	...
	public MongoClusterMaxRecord getMaxDbTemp() { return maxDbTemp; }
	public MongoClusterMaxRecord getMaxDbUser() { return maxDbUser; }
	...
	private MongoClusterMaxRecord getMaxDbTemp_() {
	...
	private MongoClusterMaxRecord getMaxDbUser_() {
		MongoClusterMaxRecord mongoClusterMaxRecord = null;
