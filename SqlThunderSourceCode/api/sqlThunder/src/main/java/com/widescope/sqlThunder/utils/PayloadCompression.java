...
public class PayloadCompression {
	...
	public static String GZIPDecompress(final byte[] compressedPayload) throws 	IOException, 
	...
	public static String ZIPDecompress(final byte[] compressedPayload) throws 	IOException, 
																				ClassNotFoundException, 
																				DataFormatException {
