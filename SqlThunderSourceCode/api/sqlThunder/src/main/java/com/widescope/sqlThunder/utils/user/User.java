...
public class User implements RestInterface {
	...
	public void setDepartment(final int department) { this.department = department; }
	
	private int title;
	public int getTitle() {	return title; }
	public void setTitle(final int title) { this.title = title; }
	
	private int manager;
	public int getManager() {	return manager; }
	public void setManager(final int manager) { this.manager = manager; }
