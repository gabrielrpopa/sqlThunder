...
public class DeleteUserTitleTask implements Callable<Boolean> {
    ...
    deleteTitleDistributed(final ConcurrentMap<String, SqlRepoDatabase> dbs, final int id) {
    ...
    public static boolean
    deleteTitle(final DbConnectionInfo connectionDetailInfo, final int id) throws Exception	{
