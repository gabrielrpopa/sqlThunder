...
import com.widescope.sqlThunder.utils.cache.CacheObject;
...
public class RestApiCacheClient {
	...
	static 
	CacheObject 
	set(	final String serverBaseAddress, 
			final String passcode, 
			final String userId,
			final String validFor,
			final String notificationProxy,
		...
		try	{
			...
			String key_ = restObject.getBody().get("key").toString();
	...
	static 
	CacheObject 
	delete(	final String serverBaseAddress, 
	        final String passcode, 
	        final String userId,
	...
	static 
	CacheObject 
	updateValidFor(	final String serverBaseAddress, 
					final String passcode, 
					final String userId,
					final String key,
					final String validFor) throws Exception	{
	...
	static 
	CacheObject 
	updateValue(	final String serverBaseAddress, 
					final String passcode, 
					final String userId,
					final String key,
					final String value) throws Exception {
	...
	static 
	CacheObject 
	update(	final String serverBaseAddress, 
			final String passcode, 
			final String userId,
			final String key,
			final String validFor,
	...
	static 
	CacheObject 
	get(	final String serverBaseAddress, 
			final String passcode, 
			final String userId,
			final String key) throws Exception
	{
