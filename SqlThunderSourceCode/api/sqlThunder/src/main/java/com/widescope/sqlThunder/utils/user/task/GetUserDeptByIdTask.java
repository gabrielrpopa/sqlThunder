...
public class GetUserDeptByIdTask implements Callable<List<Department>> {
    ...
    getDeptByIdDistributed(final ConcurrentMap<String, SqlRepoDatabase> dbs, final long id) {
    ...
    getDepartments(final DbConnectionInfo connectionDetailInfo, final long id) throws Exception {
